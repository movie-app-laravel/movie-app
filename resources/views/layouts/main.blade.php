        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
                    ...
                    <a href="{{ route('movies.index') }}">
                        <svg class="w-32" viewBox="0 0 96 24" fill="none">
                            <!-- <path
                                ...
                                fill="#fff" /> -->
                            <text x="0" y="17" fill="white">Movie App</text>
                        </svg>
                    </a>
                </li>
            ...
            <!-- <div class="flex flex-col md:flex-row items-center">
                <livewire:search-dropdown>
                    <div class="md:ml-4 mt-3 md:mt-0">
                        <a href="#">
                            <img src="" alt="me" class="rounded-full w-8 h-8">
                        </a>
                    </div>
            </div> -->
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="flex relative">
                    <input type="text" class="bg-gray-800 rouned-full w-64 px-4 pl-8 py-1" placeholder="Search">
                </div>
            </div>
        </div>
    </nav>
